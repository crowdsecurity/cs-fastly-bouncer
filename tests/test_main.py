...
from fastly_bouncer.utils import CustomFormatter, VERSION
...
class TestBuildClientParams(unittest.TestCase):
    ...
    def test_all_optional_parameters_set(self):
        ...
        expected_keys = {
            "api_key", "lapi_url", "interval", "user_agent", "scopes",
            "only_include_decisions_from", "include_scenarios_containing",
            "exclude_scenarios_containing", "insecure_skip_verify",
